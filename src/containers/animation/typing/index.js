...
class Typing extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      contentList: [
        ...
        'mèo bên mị mãi mãi',
        'ahihi',
        'mị số sướng to have mèo :3',
        'đừng giận mèo nữa nha',
        'lots of moments, lots of mistakes',
        'forgiven',
        'mị mụp',
        'mèo handsome',
        '<3 <3',
  ...
  setContent() {
    ...
    this.setState(prevState => ({
      content: prevState.contentList[Math.floor(random1 * prevState.contentList.length)],
      style: {
        ...prevState.style,
        top: `${Math.floor((random1 * 80) + 1)}vh`,
        right: `${Math.floor((random2 * 80) + 1)}vw`,
        color: prevState.colors[Math.floor(random1 * prevState.colors.length)],
      },
    }));
  }
